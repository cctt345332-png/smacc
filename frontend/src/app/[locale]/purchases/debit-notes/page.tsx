            ...
            <table>
              ...
              <tbody>
                {items.map((dn: any) => (
                  <tr key={dn.id}>
                    <td>
                      <Link href={`/${locale}/purchases/debit-notes/${dn.id}`} style={{ fontWeight: 700, color: "#5D7E9F", textDecoration: "none" }}>
                    ...
                    <td style={{ textAlign: "end", fontWeight: 700, color: "#5D7E9F" }}>{fmt(dn.total)} SAR</td>
                    <td>
