      ...
      {data && (
        <>
          ...
          <div className="grid-3" style={{ marginBottom: 20 }}>
            {[
              { label: ar ? "إجمالي الفواتير" : "Total Invoiced", value: data.summary.total_invoiced, color: "#485668" },
                ...
                <table>
                  ...
                  <tbody>
                    {data.transactions.map((t: any, i: number) => (
                      <tr key={i} style={{ background: t.type === "payment" ? "#F0FDF4" : "transparent" }}>
                        ...
                        <td style={{ textAlign: "end", color: "#485668", fontWeight: t.debit > 0 ? 600 : 400 }}>
                  ...
                  <tfoot>
                    <tr style={{ background: "#F8FAFC", fontWeight: 700, borderTop: "2px solid var(--border)" }}>
                      ...
                      <td style={{ textAlign: "end", padding: "12px 16px", color: "#485668" }}>{fmt(data.summary.total_invoiced)}</td>
