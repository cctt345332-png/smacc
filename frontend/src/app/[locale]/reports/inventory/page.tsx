      ...
      {data && (
        <>
          ...
          <div className="grid-4" style={{ marginBottom: 20 }}>
            {[
              { label: ar ? "إجمالي الأصناف" : "Total Items", value: data.summary.total_items, color: "#587795", isMoney: false },
              { label: ar ? "قيمة المخزون (تكلفة)" : "Stock Value (Cost)", value: data.summary.total_cost_value, color: "#5D7E9F", isMoney: true },
                ...
                <table>
                  ...
                  <tbody>
                    {filtered.map((row: any) => (
                      <tr key={row.id} style={row.is_low_stock ? { background: "#FFF5F5" } : {}}>
                        ...
                        <td style={{ textAlign: "end", fontWeight: 600, color: "#5D7E9F" }}>{fmt(row.cost_value)} SAR</td>
                  ...
                  <tfoot>
                    <tr style={{ background: "#F8FAFC", fontWeight: 700, borderTop: "2px solid var(--border)" }}>
                      ...
                      <td style={{ textAlign: "end", padding: "12px 16px", color: "#5D7E9F" }}>
