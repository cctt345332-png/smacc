      ...
      {alerts && (
        <div className="grid-4" style={{ marginBottom: 20 }}>
          {[
            ...
            { label: ar ? "إجمالي قيمة المخاطر" : "Total At-Risk Value", count: alerts.expired_count + alerts.near_expiry_count, value: alerts.expired_value + alerts.near_expiry_value, color: "#65707E", bg: "#F5F3FF", icon: "money" },
          ].map(s => (
