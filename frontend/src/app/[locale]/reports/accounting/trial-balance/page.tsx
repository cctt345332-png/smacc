            ...
            <table>
              ...
              <tbody>
                {data.map(r => (
                  <tr key={r.account_id}>
                    ...
                    <td style={{ textAlign: "end", color: "#2563EB" }}>{Number(r.period_debit) > 0 ? fmt(Number(r.period_debit)) : "—"}</td>
              ...
              <tfoot>
                <tr style={{ background: "#F8FAFC", fontWeight: 700, borderTop: "2px solid var(--border)" }}>
                  ...
                  <td style={{ textAlign: "end", padding: "12px 16px", color: "#2563EB" }}>{fmt(totals.pd)}</td>
