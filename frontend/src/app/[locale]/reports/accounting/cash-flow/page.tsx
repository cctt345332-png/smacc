    ...
    <>
      ...
      {data && (
        <div className="card">
          ...
          <div style={{ padding: 0 }}>
            {/* Operating */}
            <div style={{ padding: "12px 20px", background: "#EFF6FF", fontWeight: 700, color: "#2563EB", borderBottom: "1px solid var(--border)" }}>
            ...
            {/* Investing */}
            <div style={{ padding: "12px 20px", background: "#F5F3FF", fontWeight: 700, color: "#7C3AED", borderBottom: "1px solid var(--border)", marginTop: 8 }}>
