    ...
    <>
      ...
      {data && (
        <div className="card" id="report-content-cash-flow">
          ...
          <div style={{ padding: 0 }}>
            {/* Operating */}
            <div style={{ padding: "12px 20px", background: "#EFF6FF", fontWeight: 700, color: "#5A187E", borderBottom: "1px solid var(--border)" }}>
            ...
            {/* Investing */}
            <div style={{ padding: "12px 20px", background: "#F5F3FF", fontWeight: 700, color: "#75617F", borderBottom: "1px solid var(--border)", marginTop: 8 }}>
