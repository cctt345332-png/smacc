        ...
        <div className="grid-2" id="report-content-balance-sheet">
          <div className="card">
            ...
            <div className="card-body" style={{ padding: "12px 0" }}>
              <Section title={ar ? "الأصول" : "Assets"} rows={data.assets} total={data.totalAssets} color="#485668" />
            </div>
          </div>
          <div className="card">
            ...
            <div className="card-body" style={{ padding: "12px 0" }}>
              ...
              <Section title={ar ? "حقوق الملكية" : "Equity"} rows={data.equity} total={data.totalEquity} color="#65707E" />
