  ...
  return (
    <>
      ...
      <div className="grid-4" style={{ marginBottom: 24 }}>
        {[
          { label: ar ? "إجمالي الجلسات" : "Total Sessions",   value: String(filtered.length),          icon: "session"  as const, color: "#485668", bg: "#EFF6FF" },
          { label: ar ? "جلسات مغلقة"    : "Closed Sessions",  value: String(closed.length),            icon: "lock"     as const, color: "#059669", bg: "#ECFDF5" },
          { label: ar ? "متوسط المبيعات" : "Avg Sales/Session", value: `${fmt(avgSales)} ${sar}`,       icon: "revenue"  as const, color: "#65707E", bg: "#F5F3FF" },
