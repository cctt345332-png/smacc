...
function PermCell({ perm }: { perm: Perm }) {
  ...
  if (perm === "r")   return <div style={{ display: "flex", justifyContent: "center" }}><span style={{ fontSize: 10, fontWeight: 700, color: "#485668", background: "#EFF6FF", padding: "1px 6px", borderRadius: 4 }}>R</span></div>;
      ...
      <div className="card">
        <div className="card-header">
          ...
          <div style={{ display: "flex", gap: 12, fontSize: 12, color: "var(--text-secondary)" }}>
            ...
            <span style={{ display: "flex", alignItems: "center", gap: 4 }}><span style={{ fontSize: 10, fontWeight: 700, color: "#485668", background: "#EFF6FF", padding: "1px 6px", borderRadius: 4 }}>R</span>{ar ? "قراءة" : "Read"}</span>
