...
export default function BackupPage({ params: { locale } }: { params: { locale: string } }) {
  const ar = locale === "ar";
  ...
  return (
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: 24 }}>
        ...
        <div className="stat-card">
          <div className="stat-icon" style={{ background: "#EFF6FF", color: "#2563EB" }}><IcClock /></div>
          <div className="stat-content">
        ...
        <div className="stat-card">
          <div className="stat-icon" style={{ background: "#F5F3FF", color: "#7C3AED" }}><IcDownload /></div>
          <div className="stat-content">
