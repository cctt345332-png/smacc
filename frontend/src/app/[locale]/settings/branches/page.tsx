...
export default function BranchesPage(props: { params: Promise<{ locale: string }> }) {
          ...
          <div className="card-body" style={{ padding: "14px 20px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span style={{ color: "#5A187E" }}><IcBuilding /></span>
            ...
            <div style={{ height: 8, background: "#F1F5F9", borderRadius: 4, overflow: "hidden" }}>
              <div style={{
                ...
                background: atLimit ? "#DC2626" : branches.length / branchLimit >= 0.8 ? "#D97706" : "#5A187E",
                borderRadius: 4,
      ...
      {branches.length === 0 ? (
        <div className="card">
          <div className="empty-state">
            <div style={{ color: "#5A187E", marginBottom: 12 }}><IcBuilding /></div>
            ...
            <div key={branchName} className="card">
              <div className="card-header">
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, background: "#EFF6FF", display: "flex", alignItems: "center", justifyContent: "center", color: "#5A187E" }}>
                    <IcBuilding />
                  </div>
                  <div>
