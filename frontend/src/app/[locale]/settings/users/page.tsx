...
const ROLES: { key: string; ar: string; en: string; color: string; bg: string; desc_ar: string; desc_en: string }[] = [
  ...
  { key: "manager",    ar: "مدير",            en: "Manager",     color: "#5D7E9F", bg: "#F5F3FF", desc_ar: "كل الوحدات بدون حذف",                  desc_en: "All modules without delete" },
  { key: "accountant", ar: "محاسب",           en: "Accountant",  color: "#587795", bg: "#EFF6FF", desc_ar: "محاسبة، مبيعات، مشتريات، خزينة",       desc_en: "Accounting, sales, purchases, treasury" },
          ...
          <div className="card-body" style={{ padding: "14px 20px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span style={{ color: "#587795" }}><IcUsers /></span>
            ...
            <div style={{ height: 8, background: "#F1F5F9", borderRadius: 4, overflow: "hidden" }}>
              <div style={{
                ...
                background: atLimit ? "#DC2626" : activeCount / userLimit >= 0.8 ? "#D97706" : "#587795",
                borderRadius: 4,
