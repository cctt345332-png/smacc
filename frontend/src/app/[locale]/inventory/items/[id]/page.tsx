            ...
            {item.tracking_type === "serial" ? (
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                {[
                  ...
                  { label: ar ? "مباع" : "Sold", value: sold.length, color: "#587795", suffix: "" },
                  { label: ar ? "قيمة المخزون (تكلفة)" : "Stock Value (Cost)", value: stockValue, color: "#5D7E9F", suffix: " SAR" },
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                {[
                  ...
                  { label: ar ? "قيمة المخزون" : "Stock Value", value: `${fmt(Number(item.quantity_on_hand) * Number(item.cost_price))} SAR`, color: "#5D7E9F" },
