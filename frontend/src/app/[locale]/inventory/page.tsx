...
export default function InventoryPage(props: { params: Promise<{ locale: string }> }) {
  ...
  const modules = [
    { label: ar ? "الأصناف" : "Items", href: `/${locale}/inventory/items`, icon: <Icon name="inventory" size={24} />, color: "#485668", desc: ar ? "إدارة المنتجات والأصناف" : "Manage products and items" },
    ...
    { label: ar ? "المستودعات" : "Warehouses", href: `/${locale}/inventory/warehouses`, icon: <Icon name="bank" size={24} />, color: "#65707E", desc: ar ? "إدارة المستودعات والفروع" : "Manage warehouses and branches" },
    ...
    <>
      ...
      {summary && (
        <div className="grid-4" style={{ marginBottom: 24 }}>
          {[
            { label: ar ? "إجمالي الأصناف" : "Total Items", value: summary.total_items, color: "#485668", suffix: "" },
            { label: ar ? "قيمة المخزون" : "Stock Value", value: fmt(summary.total_value), color: "#65707E", suffix: " SAR" },
      ...
      <div style={{ marginTop: 24 }}>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <Link href={`/${locale}/reports/inventory`} className="btn btn-secondary btn-sm" style={{ color: "#485668", borderColor: "#48566840" }}>
