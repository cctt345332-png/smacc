  ...
  return (
    <div>
      ...
      <div className="grid-4" style={{ marginBottom: 24 }}>
        ...
        <div className="stat-card">
          <div className="stat-icon" style={{ background: "#DBEAFE", color: "#2563EB" }}><IcCalendar /></div>
          <div className="stat-content"><div className="stat-label">{ar ? "إجازة" : "On Leave"}</div><div className="stat-value" style={{ color: "#2563EB" }}>{onLeave}</div></div>
        </div>
      </div>
