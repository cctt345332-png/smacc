...
export default function DepartmentsPage(props: { params: Promise<{ locale: string }> }) {
    ...
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: 24 }}>
        <div className="stat-card">
          <div className="stat-icon" style={{ background: "#EFF6FF", color: "#587795" }}><IcBuilding /></div>
                ...
                <tr key={dept.id}>
                  <td>
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      <div style={{ width: 36, height: 36, borderRadius: 8, background: "#EFF6FF", display: "flex", alignItems: "center", justifyContent: "center", color: "#587795", flexShrink: 0 }}><IcBuilding /></div>
                      <div>
