            ...
            return (
              <div key={inv.id} onClick={() => setSelected(inv)}
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ fontFamily: "monospace", fontWeight: 700, fontSize: 13, color: "#5D7E9F" }}>
                    {inv.invoice_number}
                  </span>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", zIndex: 800,
          ...
          <div style={{ background: "var(--surface)", borderRadius: "20px 20px 0 0",
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 14 }}>
              <div>
                <div style={{ fontFamily: "monospace", fontWeight: 800, fontSize: 18, color: "#5D7E9F" }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <button onClick={() => window.open(`/${locale}/sales/invoices/${selected.id}?print=1`, "_blank")}
                  style={{ padding: "6px 12px", borderRadius: 8, border: "1px solid #BFDBFE",
                    background: "#EFF6FF", color: "#587795", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>
                  PDF
                </button>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 14 }}>
              {[
                { label: ar ? "الإجمالي" : "Total", value: fmt(selected.total) + " SAR", color: "#5D7E9F" },
