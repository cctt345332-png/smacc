...
const PLAN_COLORS: Record<string, string> = {
  trial: "#059669", starter: "#2563EB", professional: "#7C3AED", enterprise: "#0F172A"
};
      ...
      {tab === "stats" && stats && (
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div className="grid-4">
            {[
              { label: ar ? "إجمالي الرسائل" : "Total Messages",  value: stats.total_messages,  Icon: IcChart, color: "#2563EB", bg: "#EFF6FF" },
              { label: ar ? "إجمالي الـ Tokens" : "Total Tokens", value: stats.total_tokens,    Icon: IcChart, color: "#7C3AED", bg: "#F5F3FF" },
