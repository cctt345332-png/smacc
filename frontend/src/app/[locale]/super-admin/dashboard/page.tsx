...
const PLAN_CFG: Record<string, { ar: string; en: string; color: string; bg: string }> = {
  ...
  starter:      { ar: "أساسية",   en: "Starter",      color: "#2563EB", bg: "#EFF6FF" },
  professional: { ar: "احترافية", en: "Professional", color: "#7C3AED", bg: "#F5F3FF" },
...
export default function SuperAdminDashboard() {
  ...
  const kpis = [
    { label: ar ? "إجمالي الشركات"    : "Total Companies",  value: stats?.total_tenants ?? 0,    Icon: IcBuilding, color: "#2563EB", bg: "#EFF6FF" },
    { label: ar ? "شركات نشطة"        : "Active Companies", value: stats?.active_tenants ?? 0,   Icon: IcCheck,    color: "#059669", bg: "#ECFDF5" },
    { label: ar ? "إجمالي المستخدمين" : "Total Users",      value: stats?.total_users ?? 0,      Icon: IcUsers,    color: "#7C3AED", bg: "#F5F3FF" },
  ...
  const quickActions = [
    { href: `/${locale}/super-admin/tenants`,    label: ar ? "إدارة الشركات"       : "Manage Companies",  Icon: IcBuilding, color: "#2563EB", bg: "#EFF6FF" },
    { href: `/${locale}/super-admin/plans`,      label: ar ? "تعديل الباقات"       : "Edit Plans",        Icon: IcDiamond,  color: "#7C3AED", bg: "#F5F3FF" },
