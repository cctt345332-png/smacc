...
const EMPTY_NEW = () => ({
  ...
  color: "#5A187E", bg: "#EFF6FF", popular: false,
          ...
          <div key={plan.key} className="card" style={{ borderColor: plan.popular ? plan.color : "var(--border)", borderWidth: plan.popular ? 2 : 1 }}>
            ...
            <div className="card-body" style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6, padding: "6px 8px", borderRadius: 8, background: "#EFF6FF", border: "1px solid #BFDBFE" }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#5A187E" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a4 4 0 0 1 4 4v1h1a3 3 0 0 1 0 6h-1v1a4 4 0 0 1-8 0v-1H7a3 3 0 0 1 0-6h1V6a4 4 0 0 1 4-4z"/><circle cx="9" cy="10" r="1" fill="#5A187E" stroke="none"/><circle cx="15" cy="10" r="1" fill="#5A187E" stroke="none"/></svg>
                <span style={{ fontSize: 11, color: "#5A187E", fontWeight: 600 }}>
                  {ar ? "دعم AI: " : "AI: "}
