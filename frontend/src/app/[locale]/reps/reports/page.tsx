...
const STATUS_COLOR: Record<string, string> = {
  draft: "#6B7280", submitted: "#D97706", approved: "#485668",
  rejected: "#DC2626", confirmed: "#059669", paid: "#059669",
  partial: "#D97706", overdue: "#DC2626", cancelled: "#6B7280",
  sent: "#485668", zatca_pending: "#D97706", zatca_cleared: "#059669", zatca_rejected: "#DC2626",
};
  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 20 }}>
        {[
          { label: ar ? "إجمالي مبيعات الفريق" : "Team Sales",     value: fmt(totalSales) + " SAR",       color: "#485668" },
          ...
          { label: ar ? "إجمالي العمولات" : "Commissions",          value: fmt(totalCommission) + " SAR",  color: "#65707E" },
        ].map(s => (
                ...
                <table>
                    ...
                    {repStats.map(({ rep, sum, pct, commission }, idx) => {
                      ...
                      return (
                        <tr key={rep.id}>
                          ...
                          <td style={{ textAlign: "end", fontWeight: 700, color: "#485668" }}>
                          ...
                          <td style={{ textAlign: "end", fontWeight: 600, color: "#65707E" }}>
                  ...
                  <tfoot>
                    <tr style={{ background: "#F8FAFC", fontWeight: 700, borderTop: "2px solid var(--border)" }}>
                      ...
                      <td style={{ textAlign: "end", padding: "10px 16px", color: "#485668" }}>{fmt(totalSales)} SAR</td>
                      <td />
                      ...
                      <td style={{ textAlign: "end", padding: "10px 16px", color: "#65707E" }}>{fmt(totalCommission)} SAR</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
                  ...
                  <table>
                    ...
                    <tfoot>
                      <tr style={{ background: "#F8FAFC", fontWeight: 700, borderTop: "2px solid var(--border)" }}>
                        ...
                        <td style={{ textAlign: "end", padding: "10px 16px", color: "#485668" }}>
