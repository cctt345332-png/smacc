  ...
  if (loading) {
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: 300, flexDirection: "column", gap: 12 }}>
        <div style={{ width: 36, height: 36, border: "3px solid var(--border)", borderTopColor: "#364152", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
        ...
        <div style={{ background: "var(--surface)", borderRadius: 16, padding: "16px 18px", border: "1px solid var(--border)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
            ...
            <span style={{
              ...
              color: pct >= 100 ? "#059669" : pct >= 70 ? "#D97706" : "#364152",
            }}>{pct}%</span>
          </div>
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <ActionCard icon={Icons.newInvoice} label={ar ? "فاتورة جديدة" : "New Invoice"}
            ...
            color="#364152" href={`${base}/reps/me/invoices/new`} />
      ...
      {recentInvoices.length > 0 && (
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
            ...
            <Link href={`${base}/reps/me/invoices`} style={{ fontSize: 12, color: "#364152", fontWeight: 700, textDecoration: "none" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {recentInvoices.map((inv: any) => {
              const statusColors: Record<string, string> = {
                paid: "#059669", confirmed: "#364152", partial: "#D97706",
        ...
        <div style={{ padding: "0 20px 14px", borderBottom: "1px solid var(--border)",
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 3 }}>
              <span style={{ fontFamily: "monospace", fontWeight: 800, fontSize: 17, color: "#364152" }}>{inv.invoice_number}</span>
            ...
            {["approved","confirmed","paid","partial"].includes(inv.status) && (
              <button onClick={handlePDF} disabled={downloading}
                style={{ padding: "6px 12px", borderRadius: 8, border: "1px solid #9BBBAD",
                  background: "#EFF2F5", color: "#364152", fontSize: 12, fontWeight: 600, cursor: "pointer",
          ...
          <div style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                ...
                {d.lines.map((line: any, i: number) => (
                  <div key={i} style={{ background: "var(--bg)", borderRadius: 10, padding: "10px 14px",
                    ...
                    <div style={{ fontWeight: 700, color: "#364152", flexShrink: 0, marginInlineStart: 12 }}>
            ...
            <div style={{ background: "var(--bg)", borderRadius: 12, padding: "12px 16px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0 0", fontWeight: 800, fontSize: 16 }}>
                ...
                <span style={{ color: "#364152" }}>{fmt2(d.total)} SAR</span>
              </div>
