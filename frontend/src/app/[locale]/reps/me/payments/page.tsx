      ...
      {loading ? (
        ...
        <div style={{ padding:40, textAlign:"center" }}>
          ...
          <button onClick={() => setShowModal(true)}
            style={{ padding:"8px 16px", borderRadius:10, border:"none", background:"#3E0865", color:"white", fontWeight:700, fontSize:13, cursor:"pointer" }}>
            + {ar ? "سند جديد" : "New Receipt"}
          </button>
        </div>
      ) : (
                ...
                {[
                  ...
                  <button key={m.v} type="button" onClick={() => {
                    ...
                    style={{ flex:1, padding:"9px", borderRadius:8, border:"2px solid",
                      borderColor: mode === m.v ? "#3E0865" : "var(--border)",
                      background: mode === m.v ? "#F4EFF7" : "var(--surface)",
                      color: mode === m.v ? "#3E0865" : "var(--text-primary)",
              ...
              {mode === "invoice" && (
                <div>
                  ...
                  {form.invoice_id && (() => {
                    ...
                    const rem = Number(inv.total||0) - Number(inv.paid_amount||0);
                    return (
                      <div style={{ marginTop:8, background:"#F4EFF7", borderRadius:10,
              ...
              {mode === "customer" && (
                <div>
                  ...
                  {customerBalance && !loadingBalance && (
                    <div style={{ marginTop:8, background:"#F4EFF7", borderRadius:10, padding:"12px 14px" }}>
                  ...
                  {[
                    ...
                    <button key={m.v} type="button" onClick={() => upd("payment_method", m.v)}
                      style={{ padding:"8px 4px", borderRadius:8, border:"2px solid",
                        borderColor: form.payment_method === m.v ? "#3E0865" : "var(--border)",
                        background: form.payment_method === m.v ? "#F4EFF7" : "var(--surface)",
                        color: form.payment_method === m.v ? "#3E0865" : "var(--text-primary)",
              ...
              <div style={{ display:"flex", gap:10 }}>
                ...
                <button onClick={handleSave} disabled={saving}
                  style={{ flex:2, padding:"12px", borderRadius:10, border:"none",
                    background: saving ? "#93C5FD" : "#3E0865", color:"white", fontSize:14, fontWeight:700, cursor:"pointer" }}>
