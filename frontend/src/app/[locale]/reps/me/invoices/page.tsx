  ...
  return (
    <button onClick={handleDownload}
      style={{
        ...
        background: "#EDF3F8", color: "#425E7A", fontWeight: 700, fontSize: 14,
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", zIndex: 800,
      ...
      <div style={{ background: "var(--surface)", borderRadius: "20px 20px 0 0",
        ...
        <div style={{ padding: "0 20px 16px", borderBottom: "1px solid var(--border)",
          ...
          <div>
            <div style={{ fontFamily: "monospace", fontWeight: 800, fontSize: 18, color: "#425E7A" }}>
              {inv.invoice_number}
            </div>
          ...
          <div style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  {data.lines.map((line: any, i: number) => (
                    <div key={i} style={{ background: "var(--bg)", borderRadius: 10,
                      ...
                      <div style={{ fontWeight: 700, fontSize: 13, color: "#425E7A", flexShrink: 0, marginInlineStart: 12 }}>
            ...
            <div style={{ background: "var(--bg)", borderRadius: 12, padding: "14px 16px",
              ...
              <div style={{ borderTop: "1px solid var(--border)", paddingTop: 8, marginTop: 4,
                ...
                <span style={{ fontWeight: 800, fontSize: 18, color: "#425E7A" }}>{fmt(data.total)} SAR</span>
              </div>
    ...
    <>
      ...
      {loading ? (
        ...
        <div style={{ padding: 40, textAlign: "center" }}>
          ...
          <Link href={`/${locale}/reps/me/invoices/new`}
            style={{ padding: "10px 20px", borderRadius: 10, background: "#425E7A",
              color: "white", fontWeight: 700, fontSize: 13, textDecoration: "none" }}>
              ...
              <div key={inv.id} onClick={() => setSelected(inv)}
                ...
                <div onClick={e => e.stopPropagation()} style={{ display: "flex", gap: 5, flexWrap: "wrap", justifyContent: "flex-end" }}>
                  {["draft", "rejected"].includes(inv.status) && (
                    <Link href={`/${locale}/reps/me/invoices/new?draft=${inv.id}`} style={{ padding: "5px 8px", border: "1px solid #9BBBAD", background: "#EDF3F8", color: "#425E7A", fontSize: 11, fontWeight: 800, textDecoration: "none" }}>{ar ? "تعديل" : "Edit"}</Link>
                  )}
                  {inv.status === "draft" && (
