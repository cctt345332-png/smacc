          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button onClick={() => coords && onSelect(coords.lat, coords.lng)}
              ...
              style={{ flex: 2, padding: "10px", borderRadius: 8, border: "none",
                background: "#3E0865", color: "white", cursor: "pointer",
    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 10 }}>
        ...
        <button onClick={openNew}
          style={{ padding: "8px 16px", borderRadius: 10, border: "none", background: "#3E0865", color: "white", fontWeight: 700, fontSize: 13, cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}>
      ...
      <div style={{ background: "var(--surface)", borderRadius: 14, border: "1px solid var(--border)", overflow: "hidden" }}>
        {loading ? (
          ...
          <div style={{ padding: 40, textAlign: "center" }}>
            ...
            <button onClick={openNew}
              style={{ padding: "8px 16px", borderRadius: 8, border: "none", background: "#3E0865", color: "white", fontWeight: 700, fontSize: 13, cursor: "pointer" }}>
              ...
              {form.latitude && form.longitude ? (
                <div style={{ display: "flex", gap: 8, alignItems: "center",
                  ...
                  <button type="button" onClick={() => setShowLocationPicker(true)}
                    style={{ fontSize: 11, color: "#3E0865", background: "none", border: "none", cursor: "pointer", fontWeight: 600 }}>
                    {ar ? "تعديل" : "Edit"}
                  </button>
                ...
                <button type="button" onClick={() => setShowLocationPicker(true)}
                  style={{ width: "100%", padding: "10px", borderRadius: 10,
                    ...
                    color: "#3E0865", fontWeight: 600, fontSize: 13, cursor: "pointer",
