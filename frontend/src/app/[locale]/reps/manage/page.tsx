  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 20 }}>
        {[
          { label: ar ? "إجمالي المناديب" : "Total Reps", value: fmtNum(reps.length), color: "#2563EB" },
                            ...
                            {pct !== null && (
                              <div style={{ marginTop: 4 }}>
                                <div style={{ height: 4, background: "var(--border)", borderRadius: 2, overflow: "hidden" }}>
                                  <div style={{ height: "100%", width: `${pct}%`, background: pct >= 100 ? "#059669" : pct >= 70 ? "#D97706" : "#2563EB", borderRadius: 2 }} />
                                </div>
