...
const PAY_METHOD: Record<string, { ar: string; color: string }> = {
  ...
  cheque:   { ar: "شيك",   color: "#65707E" },
  transfer: { ar: "تحويل", color: "#485668" },
};
        ...
        <div style={{ padding: "20px 24px 16px", borderBottom: "1px solid var(--border)",
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
              <span style={{ fontFamily: "monospace", fontWeight: 800, fontSize: 18, color: "#485668" }}>
                {inv.invoice_number}
              </span>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={handlePDF} disabled={downloading}
              style={{ padding: "6px 14px", borderRadius: 8, border: "1px solid #BFDBFE",
                background: "#EFF6FF", color: "#485668", fontSize: 13, fontWeight: 600,
          ...
          <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: 16 }}>
                        ...
                        <tr key={i} style={{ borderBottom: "1px solid var(--border)" }}>
                          <td style={{ padding: "10px 12px" }}>
                            ...
                            {line.serial_numbers?.length > 0 && (
                              <div style={{ fontSize: 11, color: "#65707E", marginTop: 2, fontFamily: "monospace" }}>
                          ...
                          <td style={{ padding: "10px 12px", textAlign: "end", fontWeight: 700, color: "#485668" }}>
            ...
            <div style={{ background: "#F8FAFC", borderRadius: 12, padding: "14px 16px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", padding: "10px 0 4px",
                ...
                <span style={{ color: "#485668" }}>{fmt(d.total)} SAR</span>
              </div>
    ...
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 20 }}>
        {[
          ...
          { label: ar ? "الفواتير المعروضة" : "Filtered", value: filtered.length, color: "#485668" },
          { label: ar ? "إجمالي المبالغ المعلّقة" : "Pending Amount", value: fmt(invoices.reduce((s: number, i: any) => s + Number(i.total || 0), 0)) + " SAR", color: "#65707E" },
