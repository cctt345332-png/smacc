...
export default function CustomerDetailPage({ params: { locale, id } }: { params: { locale: string; id: string } }) {
  const ar = locale === "ar";
  ...
  return (
    <>
      ...
      <div className="grid-3" style={{ marginBottom: 20 }}>
        {[
          { label: ar ? "إجمالي الفواتير" : "Total Invoiced", value: `${fmt(totalInvoiced)} SAR`, color: "#2563EB", icon: <Icon name="invoice" size={20} /> },
