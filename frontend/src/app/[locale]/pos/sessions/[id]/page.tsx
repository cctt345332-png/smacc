    ...
    <>
      ...
      <div className="grid-4" style={{ marginBottom: 24 }}>
        {[
          ...
          { label: isAr ? "إجمالي النقد" : "Cash Sales",        value: `${fmt(Number(session.total_cash))} ${sar}`,     icon: "cash"     as const, color: "#2563EB", bg: "#EFF6FF" },
          { label: isAr ? "إجمالي البطاقة" : "Card Sales",      value: `${fmt(Number(session.total_card))} ${sar}`,     icon: "card"     as const, color: "#7C3AED", bg: "#F5F3FF" },
        ...
        <div className="card" style={{ padding: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <div style={{ borderTop: "1px solid var(--border)", paddingTop: 8, display: "flex", justifyContent: "space-between", fontSize: 14, fontWeight: 700 }}>
              ...
              <span style={{ color: "#2563EB" }}>{fmt(expectedCash)} {sar}</span>
            </div>
            {actualCash != null && (
              <>
