          ...
          {selectedAcc && (
            <div style={{ display: "flex", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
              {[
                ...
                { label: ar ? "إجمالي المدين" : "Total Debit", value: `${fmt(totalDebit)} ${ar ? "ر.س" : "SAR"}`, color: "#2563EB" },
                ...
                <table>
                  ...
                  <tbody>
                    {rows.map((r, i) => (
                      <tr key={i}>
                        ...
                        <td style={{ textAlign: "end", color: "#2563EB", fontWeight: Number(r.debit) > 0 ? 600 : 400 }}>{Number(r.debit) > 0 ? fmt(Number(r.debit)) : "—"}</td>
                  ...
                  <tfoot>
                    <tr style={{ background: "#F8FAFC", borderTop: "2px solid var(--border)", fontWeight: 700 }}>
                      ...
                      <td style={{ textAlign: "end", padding: "12px 16px", color: "#2563EB" }}>{fmt(totalDebit)}</td>
