...
export default function NewJournalPage({ params: { locale } }: { params: { locale: string } }) {
  const ar = locale === "ar";
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tfoot>
              <tr style={{ background: "#F8FAFC", borderTop: "2px solid var(--border)" }}>
                ...
                <td style={{ padding: "12px 16px", textAlign: "end", fontWeight: 700, fontSize: 14, color: "#2563EB" }}>
