...
export default function BankAccountsPage({ params: { locale } }: { params: { locale: string } }) {
  const ar = locale === "ar";
    ...
    <>
      ...
      <div className="grid-3" style={{ marginBottom: 20 }}>
        <div className="stat-card">
          <div className="stat-icon" style={{ background: "#2563EB18", color: "#2563EB" }}><Icon name="bank" size={20} /></div>
