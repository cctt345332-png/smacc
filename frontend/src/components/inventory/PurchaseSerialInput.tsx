    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
      <div style={{ background: "white", borderRadius: 16, width: "100%", maxWidth: 720, maxHeight: "90vh", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "16px 20px", borderBottom: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "center", flexShrink: 0 }}>
          <div>
            <div style={{ fontWeight: 700, fontSize: 15, color: "#65707E" }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            <span style={{
              background: serials.length > 0 ? "#65707E" : "#F1F5F9",
          ...
          {([
            ...
            <button key={t.key} onClick={() => setTab(t.key)}
              style={{
                ...
                borderBottom: tab === t.key ? "2px solid #65707E" : "2px solid transparent",
                color: tab === t.key ? "#65707E" : "var(--text-secondary)",
                fontWeight: tab === t.key ? 700 : 500, fontSize: 13, cursor: "pointer", marginBottom: -2,
              }}>
              {t.label}
              {t.key === "manual" && serials.length > 0 && (
                <span style={{ marginInlineStart: 6, background: "#65707E", color: "white", borderRadius: 10, padding: "1px 6px", fontSize: 11 }}>
                  {serials.length}
                </span>
              )}
            </button>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: 16 }}>
          ...
          <div style={{ background: "#F5F3FF", border: "1px solid #DDD6FE", borderRadius: 10, padding: "12px 14px", marginBottom: 14 }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: "#65707E", marginBottom: 8 }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                ...
                {(["new", "used", "refurbished"] as const).map(c => (
                  <button key={c} type="button" onClick={() => setDefaultCondition(c)}
                    style={{
                      ...
                      borderColor: defaultCondition === c ? "#65707E" : "var(--border)",
                      background: defaultCondition === c ? "#65707E" : "white",
              ...
              {serials.length > 0 && (
                <button type="button" onClick={applyToAll}
                  style={{ padding: "5px 10px", borderRadius: 6, fontSize: 12, border: "1px solid #65707E", background: "white", color: "#65707E", cursor: "pointer", fontWeight: 600 }}>
          ...
          {tab === "paste" && (
            <div>
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center", marginTop: 8 }}>
                ...
                {serials.length > 0 && (
                  <span style={{ fontSize: 12, color: "#65707E", marginInlineStart: "auto", fontWeight: 700 }}>
        ...
        <div style={{ padding: "12px 20px", borderTop: "1px solid var(--border)", display: "flex", gap: 8, justifyContent: "space-between", alignItems: "center", flexShrink: 0 }}>
          <div style={{ fontSize: 12, color: "var(--text-secondary)" }}>
            {serials.length > 0 ? (
              <span style={{ color: "#65707E", fontWeight: 700 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button
              ...
              style={{ background: "#65707E", borderColor: "#65707E" }}
