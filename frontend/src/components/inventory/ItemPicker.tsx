              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: "var(--text-secondary)", marginTop: 2, display: "flex", gap: 8 }}>
                  ...
                  {item.tracking_type === "serial" && (
                    <span style={{ color: "#7C3AED", fontWeight: 600 }}>سيريال</span>
                  )}
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 11, color: isSerial ? "#7C3AED" : "#059669", marginTop: 1 }}>
            {isSerial
              ? (value.serial_number
                ...
                <div style={{ background: "#F5F3FF", border: "1px solid #C4B5FD", borderRadius: 8, padding: "8px 12px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <button type="button" onClick={() => setShowPurchaseSerialInput(true)}
                      style={{ background: "none", border: "1px solid #7C3AED", borderRadius: 6, padding: "3px 8px", fontSize: 11, color: "#7C3AED", cursor: "pointer" }}>
                      {ar ? "تعديل" : "Edit"}
                    </button>
                  </div>
                  <div style={{ marginTop: 4, fontSize: 10, color: "#7C3AED", fontFamily: "monospace" }}>
