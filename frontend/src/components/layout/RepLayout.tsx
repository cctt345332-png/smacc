...
export default function RepLayout({
  ...
  return (
    <div className="rep-legacy-shell" style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <style jsx global>{`
        .rep-legacy-shell { --rep-green:#364152; --rep-paper:#FFFEFA; --rep-grid:#C8D0C7; --rep-soft:#EFF2F5; background-color:var(--rep-paper); background-image:linear-gradient(rgba(11,93,74,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(11,93,74,.035) 1px,transparent 1px); background-size:24px 24px; color:#1F2D27; }
        ...
        .rep-legacy-shell .rep-legacy-toolbar a { background:linear-gradient(#16806a,#364152); color:#fff; border:1px solid #252F3D; border-radius:2px; padding:6px 10px; font-size:12px; font-weight:700; text-decoration:none; white-space:nowrap; }
        ...
        .rep-legacy-shell .btn-primary, .rep-legacy-shell .btn.btn-primary { background:linear-gradient(#16806A,#364152) !important; border:1px solid #252F3D !important; color:#fff !important; border-radius:2px !important; box-shadow:none !important; }
        ...
        .rep-legacy-shell .card-header { background:#EFF2F5 !important; border-bottom:1px solid #C8D0C7 !important; }
        ...
        .rep-legacy-shell input:focus, .rep-legacy-shell select:focus, .rep-legacy-shell textarea:focus { outline:2px solid #9BBBAD !important; outline-offset:-1px !important; border-color:#364152 !important; }
        .rep-legacy-shell input[type="checkbox"], .rep-legacy-shell input[type="radio"] { accent-color:#364152 !important; }
        .rep-legacy-shell a[style*="background: rgb(37, 99, 235)"], .rep-legacy-shell button[style*="background: rgb(37, 99, 235)"], .rep-legacy-shell a[style*="background: rgb(124, 58, 237)"], .rep-legacy-shell button[style*="background: rgb(124, 58, 237)"], .rep-legacy-shell a[style*="background: rgb(59, 130, 246)"], .rep-legacy-shell button[style*="background: rgb(59, 130, 246)"], .rep-legacy-shell a[style*="background: rgb(99, 102, 241)"], .rep-legacy-shell button[style*="background: rgb(99, 102, 241)"] { background:linear-gradient(#16806A,#364152) !important; border:1px solid #252F3D !important; color:#fff !important; border-radius:2px !important; box-shadow:none !important; }
        .rep-legacy-shell [style*="color: rgb(37, 99, 235)"], .rep-legacy-shell [style*="color: rgb(124, 58, 237)"], .rep-legacy-shell [style*="color: rgb(59, 130, 246)"], .rep-legacy-shell [style*="color: rgb(99, 102, 241)"], .rep-legacy-shell [style*="color: rgb(79, 70, 229)"], .rep-legacy-shell [style*="color: rgb(139, 92, 246)"] { color:#364152 !important; }
        .rep-legacy-shell [style*="background: rgb(239, 246, 255)"], .rep-legacy-shell [style*="background: rgb(245, 243, 255)"], .rep-legacy-shell [style*="background: rgb(238, 242, 255)"], .rep-legacy-shell [style*="background: rgb(243, 244, 246)"] { background:#EFF2F5 !important; }
        ...
        @media (max-width: 799px) { .rep-legacy-shell .rep-legacy-menu { display:none; } .rep-legacy-shell .rep-legacy-toolbar span { display:none; } .rep-legacy-shell .rep-legacy-toolbar { justify-content:center; } .rep-legacy-shell .rep-mobile-nav { position:fixed; display:flex; align-items:stretch; justify-content:space-around; bottom:0; inset-inline:0; height:76px; background:#FFFEFA; border-top:2px solid #364152; box-shadow:0 -4px 12px rgba(11,93,74,.14); z-index:220; padding:5px 4px max(5px, env(safe-area-inset-bottom)); } .rep-legacy-shell .rep-mobile-nav button { flex:1; min-width:0; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:4px; padding:4px 2px; border:0 !important; border-radius:2px !important; background:transparent; color:#6B7E75; font-family:inherit; cursor:pointer; } .rep-legacy-shell .rep-mobile-nav .rep-nav-icon { width:31px; height:29px; display:flex; align-items:center; justify-content:center; border:1px solid transparent; } .rep-legacy-shell .rep-mobile-nav .rep-nav-label { font-size:11px; font-weight:800; white-space:nowrap; } .rep-legacy-shell .rep-mobile-nav button.active { color:#364152; background:#EFF2F5; border:1px solid #9BBBAD !important; } .rep-legacy-shell .rep-mobile-nav button.active .rep-nav-icon { background:#364152; color:#fff; border-color:#252F3D; } .rep-legacy-shell main { padding-bottom:94px !important; } }
      ...
      {isImpersonating && (
                <div style={{
          background: "#EFF2F5", color: "#364152",
          ...
          <button onClick={handleExitImpersonation} style={{
            background: "#FFFEFA", border: "1px solid #364152", borderRadius: 1,
            color: "#364152", padding: "3px 9px", cursor: "pointer", fontWeight: 800, fontSize: 11,
      ...
      <header style={{
        ...
        background: "linear-gradient(180deg,#11725D,#364152)",
        color: "#fff",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{
            ...
            background: "#EFF2F5",
            color: "#364152", display: "flex", alignItems: "center",
