...
const kindMeta: Record<PrintDocumentKind, { ar: string; en: string; accent: string; tax: boolean; negative?: boolean }> = {
  tax_invoice: { ar: "فاتورة ضريبية", en: "Tax Invoice", accent: "#425E7A", tax: true },
  simplified_invoice: { ar: "فاتورة ضريبية مبسطة", en: "Simplified Tax Invoice", accent: "#425E7A", tax: true },
  ...
  sales_order: { ar: "أمر بيع", en: "Sales Order", accent: "#425E7A", tax: false },
  purchase_order: { ar: "أمر شراء", en: "Purchase Order", accent: "#4C6B89", tax: false },
  purchase_bill: { ar: "فاتورة مورد", en: "Purchase Bill", accent: "#4C6B89", tax: false },
